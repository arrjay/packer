...
ftp -o /usr/local/dist/npth-1.3.tar.bz2 https://gnupg.org/ftp/gcrypt/npth/npth-1.3.tar.bz2
...
ftp -o /usr/local/dist/libgpg-error-1.27.tar.bz2 https://gnupg.org/ftp/gcrypt/libgpg-error/libgpg-error-1.27.tar.bz2
...
ftp -o /usr/local/dist/libksba-1.3.5.tar.bz2 https://gnupg.org/ftp/gcrypt/libksba/libksba-1.3.5.tar.bz2
...
ftp -o /usr/local/dist/libassuan-2.4.3.tar.bz2 https://gnupg.org/ftp/gcrypt/libassuan/libassuan-2.4.3.tar.bz2
...
ftp -o /usr/local/dist/libgcrypt-1.7.6.tar.bz2 https://gnupg.org/ftp/gcrypt/libgcrypt/libgcrypt-1.7.6.tar.bz2
