...
ftp -o /usr/local/dist/npth-1.3.tar.bz2 ${GNUPG_MIRROR}/npth/npth-1.3.tar.bz2
...
ftp -o /usr/local/dist/libgpg-error-1.27.tar.bz2 ${GNUPG_MIRROR}/libgpg-error/libgpg-error-1.27.tar.bz2
...
ftp -o /usr/local/dist/libksba-1.3.5.tar.bz2 ${GNUPG_MIRROR}/libksba/libksba-1.3.5.tar.bz2
...
ftp -o /usr/local/dist/libassuan-2.4.3.tar.bz2 ${GNUPG_MIRROR}/libassuan/libassuan-2.4.3.tar.bz2
...
ftp -o /usr/local/dist/libgcrypt-1.7.6.tar.bz2 ${GNUPG_MIRROR}/libgcrypt/libgcrypt-1.7.6.tar.bz2
...
ftp -o /usr/local/dist/gnupg-2.1.19.tar.bz2 ${GNUPG_MIRROR}/gnupg/gnupg-2.1.19.tar.bz2
...
ftp -o /usr/local/dist/gnupg-1.4.21.tar.bz2 ${GNUPG_MIRROR}/gnupg/gnupg-1.4.21.tar.bz2
...
ftp -o /usr/local/dist/pinentry-1.0.0.tar.bz2 ${GNUPG_MIRROR}/pinentry/pinentry-1.0.0.tar.bz2
